...
\textbf{
	\noindent
	Read the tournament details (\url{https://www.cvhsmath.org/cvjmt/tournament-details/}) and the rules (\url{https://www.cvhsmath.org/cvjmt/tournament-rules/}) before you begin.
